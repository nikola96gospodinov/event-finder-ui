                  ...
                  <div className="flex items-center gap-3 text-sm text-purple-800">
                    ...
                    <span className="font-medium">
                      ...
                      {profile.weekday_start_time && profile.weekday_end_time
                        ? `${formatTime(
                            profile.weekday_start_time
                          )} - ${formatTime(profile.weekday_end_time)}`
                        : "All day"}
                    </span>
                  </div>
                  <div className="flex items-center gap-3 text-sm text-purple-800">
                    ...
                    <span className="font-medium">
                      ...
                      {profile.weekend_start_time && profile.weekend_end_time
                        ? `${formatTime(
                            profile.weekend_start_time
                          )} - ${formatTime(profile.weekend_end_time)}`
                        : "All day"}
                    </span>
                  </div>
                </div>
          ...
          <Card className="shadow-2xl border-0 bg-white/80 backdrop-blur-sm">
            <CardHeader className="text-center bg-gradient-to-r from-purple-600 to-pink-600 text-white rounded-t-lg">
              ...
              <CardDescription className="text-purple-50 text-lg font-semibold">
                Our AI agent will analyze your profile and find the best events
                for you. Results will be sent to your email.
              </CardDescription>
            </CardHeader>
                ...
                <>
                  <div className="space-y-4">
                    ...
                    <p className="text-sm text-purple-700 pl-6">
                      When enabled, the agent will be more selective and only
                      return events that closely match your interests and
                      preferences.
                    </p>
                  </div>
